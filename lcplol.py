...
cred = credentials.Certificate("C:/Users/18DCummins.ACC/Downloads/lc-project-457ba-firebase-adminsdk-fwptw-bfd7bb7307.json")
...
while True:
    ...
    if mb_one:
        ...
        numb = str(numb)
        if numb.isdigit():
            ref.update({str(int(time.time())):{'study_time(minutes)':counter, 'Location':source, 'Wasted_Time(minutes)':percentage}})
        else:
